...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Yusra — Deep Carbon + Ice Cyan + Neutral + Status
        "deep-carbon": "#0A0A0C",
        "deep-2": "#111113",
        "deep-3": "#191A1E",
        ...
        "text-muted": "#8E8E93",
        "text-faint": "#5A5A60",
        // Core — Ice Cyan only accent
        "ice-cyan": "#00F0FF",
        "ice-cyan-2": "#00D4FF",
        "ice-glow": "rgba(0, 240, 255, 0.16)",
        "ice-subtle": "rgba(0, 240, 255, 0.07)",
        // Status — amber / emerald
        "yusra-amber": "#FFB800",
        "yusra-amber-glow": "rgba(255,184,0,0.14)",
        "yusra-emerald": "#00E5A0",
        "yusra-emerald-glow": "rgba(0,229,160,0.14)",
      ...
      keyframes: {
        ...
        pulseCyan: { "0%,100%": { opacity: "0.55", boxShadow: "0 0 12px rgba(0,240,255,0.25)" }, "50%": { opacity: "1", boxShadow: "0 0 22px rgba(0,240,255,0.45)" } },
        hudIn: { "0%": { opacity: "0", transform: "translateY(8px) scale(0.98)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
      },
      animation: { scan: "scan 3.2s linear infinite", pulseCyan: "pulseCyan 2.2s ease-in-out infinite", hudIn: "hudIn 0.32s ease-out" },
